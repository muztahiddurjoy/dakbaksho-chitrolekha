...
const LandingPage = () => {
  return (
    <div className='h-[100vh] w-full bg-darkRed flex items-center justify-center flex-col gap-3'>
        ...
        <p className='md:w-[400px] px-5 mt-5 text-center font-semibold text-lightBrown'>"ডাকবাক্স- খোলা চিঠি উৎসব ১৪৩১" হলো একটি সাহিত্যিক আয়োজন, যেখানে অংশগ্রহণকারীরা তাদের অনুভূতি চিঠির মাধ্যমে প্রকাশ করতে পারবেন এবং সেরা চিঠিগুলো পুরস্কৃত হবে।</p>
